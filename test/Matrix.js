const {
  ...
  describe("Matrix", function () {
    ...
    async function deployPattern() {
      ...
      const Pattern = await ethers.getContractFactory("MatrixPattern");
