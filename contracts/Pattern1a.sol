...
contract StripePatternV1a {
    ...
    function randomizePattern(uint256 tokenId) internal pure returns (Stripe[] memory stripes) {
    ...
    function getSvgData(uint256 _tokenId) external pure returns (string memory) {
